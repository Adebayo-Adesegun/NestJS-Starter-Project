...
- Coverage is generated by the CI (`npm run test:cov`) and stored in the `coverage/` directory. Reports are not uploaded to any external paid service by default.
